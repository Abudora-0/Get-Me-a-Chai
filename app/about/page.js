...
const benefits = [
  {
    ...
    desc: "Fans contribute directly to your work, with no middlemen and no complicated tiers.",
  },
  {
    numeral: "II",
  ...
  },
  {
    numeral: "IV",
    title: "Instant Setup",
    desc: "Sign in with GitHub or Google, add your payment details, and you're live in minutes.",
  },
  {
    numeral: "V",
    title: "Secure Payments",
    desc: "Pay directly via JazzCash, Easypaisa, or bank transfer, no middleman gateway.",
  },
  {
    numeral: "VI",
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-7">
          {[
            ...
            { step: "2", title: "Set Up Your Page", desc: "Add a profile photo, cover image, and list your JazzCash, Easypaisa, or bank details to receive payments." },
            { step: "3", title: "Share & Earn", desc: "Share your unique page link. Fans visit and buy you a chai, and the money lands in your account." },
          ].map(s => (
