      ...
      <div className="w-full max-w-md">
        ...
        <div className="deco-card p-9 flex flex-col gap-4">
          ...
          <button
            ...
            className="btn-deco flex items-center justify-center gap-3 w-full !normal-case !tracking-[0.08em] !text-sm !py-3.5"
          >
          ...
          <div className="deco-divider my-2 text-[0.55rem] uppercase tracking-[0.25em]">
            more options soon
          </div>

          {/* Google — coming soon */}
          <button disabled className="flex items-center gap-3 w-full px-5 py-3.5 border border-[#a8841c]/25 text-[#8fa199] font-medium cursor-not-allowed text-sm">
            ...
            <span className="ml-auto text-[0.6rem] uppercase tracking-[0.18em] border border-[#a8841c]/30 text-[#a8841c] px-2 py-0.5">Soon</span>
          </button>
